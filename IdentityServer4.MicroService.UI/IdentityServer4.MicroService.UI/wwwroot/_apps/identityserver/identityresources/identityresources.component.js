(function () {
    ...
    angular
        ...
        {
            templateUrl: 'identityresources/identityresources.template.html',
            controller: ['$scope', '$timeout', function IdentityresourcesController($scope, $timeout) {
                var vm = this;
                vm.Theads = [
                    { ID: 'userId', Title: '标识' },
                    { ID: 'userName', Title: '名称' },
                    { ID: 'createDate', Title: '描述' },
                ];
